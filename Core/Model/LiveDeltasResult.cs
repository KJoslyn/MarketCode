...
namespace Core.Model
{
    ...
    {
        public LiveDeltasResult(TimeSortedCollection<PositionDelta> liveDeltas, Dictionary<string, OptionQuote> quotes, bool skippedDeltaDueToLowConfidence)
        {
        ...
        public TimeSortedCollection<PositionDelta> LiveDeltas { get; }
